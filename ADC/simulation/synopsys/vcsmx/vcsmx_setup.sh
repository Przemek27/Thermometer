...
if [ $SKIP_COM -eq 0 ]; then
  vhdlan -xlrm $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/ADC_modular_adc_0.vhd" -work modular_adc_0
  vhdlan -xlrm $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/ADC_altpll_0.vho"      -work altpll_0     
